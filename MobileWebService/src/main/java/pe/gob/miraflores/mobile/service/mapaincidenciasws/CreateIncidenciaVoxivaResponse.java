...
/**
 * <p>Clase Java para createIncidenciaVoxivaResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="createIncidenciaVoxivaResponse">
 *   &lt;complexContent>
...
@XmlType(name = "createIncidenciaVoxivaResponse", propOrder = {
    "_return"
})
public class CreateIncidenciaVoxivaResponse {

...
CierreCalle.service = {
	...
	anularIncidencia:function(){
		...
		showBrujula:function(idMap,image,size){
			...
			$('#'+idMap).append('<div id="'+idMap+'_brujula" style="position: absolute;width: '+(size)+'px;height: '+(size)+'px;top: 5px;right: 5px;"><img src="'+(image?image:PATH_PROYECTO_BASE+'images/brujula.png')+'" /></div>');
